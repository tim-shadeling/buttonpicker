...
local ListChoiceScreen = Class(Screen, function(self, list_items, title_text, body_text, buttons, spacing, nohelpbutton, current_choice)
    ...
    self.dialog = self.proot:AddChild(TEMPLATES.CurlyWindow(300, scroll_height + body_height,
            title_text,
            self.buttons,
            spacing,
...
function ListChoiceScreen:GetHelpText()
